...
class NMF(AlgoBase):
    ...
    Args:
        ...
        n_epochs: The number of iteration of the SGD procedure. Default is
            ``50``.
        reg_u: The regularization term for users :math:`\lambda_u`. Default is
            ``0.06``.
        reg_i: The regularization term for items :math:`\lambda_i`. Default is
            ``0.06``.
    ...
    def __init__(self, n_factors=15, n_epochs=50, reg_u=.06, reg_i=.06,
    ...
    def sgd(self, trainset):
        ...
        cdef int u, i, f
        cdef double r, est, l
        cdef double reg_u = self.reg_u
        cdef double reg_i = self.reg_i
